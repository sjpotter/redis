...
REDISMODULE_API int (*RedisModule_GetKeysInSlot)(RedisModuleCtx *ctx, unsigned int slot, unsigned int max_keys, RedisModuleString ** array, size_t *count);
...
static int RedisModule_Init(RedisModuleCtx *ctx, const char *name, int ver, int apiver) {
    ...
    REDISMODULE_GET_API(GetKeysInSlot);
